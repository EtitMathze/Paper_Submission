...
import math
import sys
from platform_exports.task_tools import polyhedron, acc_axis, t_axis, task, u_axis
...
def create_local_to_global_dict(
        tasks: list[task], units: list[platform_exports.unit_tools.unit]
    ) -> dict[task, dict[int, int]]:
        """
