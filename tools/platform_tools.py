...
class platform_schedule:
    def __init__(
        ...
        units: list[tools.unit_tools.unit],
    ...
    def get_no_timeslots(self) -> int:
        ...
        return self.S_matrix_.shape[tools.schedule_tools.t_axis]

    def get_tasks(self) -> list[tools.task_tools.task]:
        return self.tasks_

    def get_units(self) -> list[tools.unit_tools.unit]:
        return self.units_
...
def print_schedule_table(
    ...
    for unit in units:
        ...
        for i in range(table.get_no_timeslots()):
            ...
            if scheduled_task is tools.schedule_tools.empty_symbol:
                scheduled_mark = "X"
            else:
