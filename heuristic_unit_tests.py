...
class TestOverlapPure(unittest.TestCase):
    ...
    def test_overlap_simple_2_first(self):
        ...
        test_cost_function = polyhedron_heuristics.homogeneous_annealing.soft_cost_function(None, None, None, None)
        calculated_overlap = test_cost_function._overlapping_time(start1,start2, end1, end2)
    ...
    def test_overlap_one_wrap_1(self):
        ...
        test_cost_function = polyhedron_heuristics.homogeneous_annealing.soft_cost_function(None, None, max_runtime=max_runtime)
        calculated_overlap = test_cost_function._overlapping_time(start1,start2, end1, end2)
...
class TestOverlapWithTask(unittest.TestCase):
    def setUp(self):
        ...
        self.cost_function = polyhedron_heuristics.homogeneous_annealing.soft_cost_function([self.task1, self.task2],1,self.total_runtime)
